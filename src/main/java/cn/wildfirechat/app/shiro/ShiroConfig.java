...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shiroFilter(SecurityManager securityManager) {
        ...
        filterChainDefinitionMap.put("/app/version", "anon");
        filterChainDefinitionMap.put("/app/user/info", "anon");
        filterChainDefinitionMap.put("/wsIndex", "anon");
        filterChainDefinitionMap.put("/websocket/**", "anon");
        filterChainDefinitionMap.put("/customer/url", "anon");
        ...
        filterChainDefinitionMap.put("/withdraw/apply", "login");
